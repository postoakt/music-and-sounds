...
<html>
    ...
    <div class="container">
            ...
            <div class="content">
                ...
                <div class="my-sounds-title">My Sounds</div>
					...
					<?php  
                        ...
                        while ($row = $result->fetch_assoc()){
							...
							echo "<div class='user-sound-container'>"
							   . "<div class='user-sound-title'><a href='../sound.php?s=" . $encid . "'>" . $row["Title"] . "</a></div>"
							   . "<div class='user-sound-description'>" . $row["Description"] . "</div>"
							   ...
							   . "<div class='icon-play-circled'>" . $row["Plays"] . "</div>"
							   . "</div>"
							   . "</div>";
                        }                      
             	    ?>
